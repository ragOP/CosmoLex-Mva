...
const MatterRatingTable = ({
  ...
  const [matterRatingData, setMatterRatingData] = useState([]);

  useEffect(() => {
    if (matterRatings && Array.isArray(matterRatings)) {
      setMatterRatingData(matterRatings);
    }
  }, [matterRatings]);
...
export default MatterRatingTable;
