...
const MatterOfficeLocationTable = ({
  matterOfficeLocations = [],
  isLoading,
  handleEdit,
  handleDelete,
  handleStatusChange,
  ...
  const [matterOfficeLocationData, setMatterOfficeLocationData] = useState([]);

  useEffect(() => {
    if (matterOfficeLocations && Array.isArray(matterOfficeLocations)) {
      setMatterOfficeLocationData(matterOfficeLocations);
    }
  }, [matterOfficeLocations]);
...
export default MatterOfficeLocationTable;
