...
const MatterMarketingSourceTable = ({
  matterMarketingSources = [],
  isLoading,
  handleEdit,
  handleDelete,
  handleStatusChange,
  ...
  const [matterMarketingSourceData, setMatterMarketingSourceData] = useState(
    []
  );

  useEffect(() => {
    if (matterMarketingSources && Array.isArray(matterMarketingSources)) {
      setMatterMarketingSourceData(matterMarketingSources);
    }
  }, [matterMarketingSources]);
  ...
  return (
    <>
      ...
      >
        <DataGrid
          rows={matterMarketingSourceData}
...
export default MatterMarketingSourceTable;
