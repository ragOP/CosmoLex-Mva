...
const MatterCaseRoleTable = ({
  ...
  const [matterCaseRoleData, setMatterCaseRoleData] = useState([]);

  useEffect(() => {
    if (matterCaseRoles && Array.isArray(matterCaseRoles)) {
      setMatterCaseRoleData(matterCaseRoles);
    }
  }, [matterCaseRoles]);
...
export default MatterCaseRoleTable;
