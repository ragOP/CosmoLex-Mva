...
const MatterCaseStatusTable = ({
  ...
  const [matterCaseStatusData, setMatterCaseStatusData] = useState([]);

  useEffect(() => {
    if (matterCaseStatuses && Array.isArray(matterCaseStatuses)) {
      setMatterCaseStatusData(matterCaseStatuses);
    }
  }, [matterCaseStatuses]);
...
export default MatterCaseStatusTable;
