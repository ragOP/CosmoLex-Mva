...
const MatterAdCampaignTable = ({
  ...
  const [matterAdCampaignData, setMatterAdCampaignData] = useState([]);

  useEffect(() => {
    if (matterAdCampaigns && Array.isArray(matterAdCampaigns)) {
      setMatterAdCampaignData(matterAdCampaigns);
    }
  }, [matterAdCampaigns]);
...
export default MatterAdCampaignTable;
