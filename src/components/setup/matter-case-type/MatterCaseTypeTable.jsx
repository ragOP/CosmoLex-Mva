...
const MatterCaseTypeTable = ({
  ...
  const [matterCaseTypeData, setMatterCaseTypeData] = useState([]);

  useEffect(() => {
    if (matterCaseTypes && Array.isArray(matterCaseTypes)) {
      setMatterCaseTypeData(matterCaseTypes);
    }
  }, [matterCaseTypes]);
...
export default MatterCaseTypeTable;
