...
const TaskUTBMSCodeTable = ({
  ...
  const [taskUTBMSCodeData, setTaskUTBMSCodeData] = useState([]);
  ...
  useEffect(() => {
    if (taskUTBMSCodes && Array.isArray(taskUTBMSCodes)) {
      setTaskUTBMSCodeData(taskUTBMSCodes);
    }
  }, [taskUTBMSCodes]);
...
export default TaskUTBMSCodeTable;
