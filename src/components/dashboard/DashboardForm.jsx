...
const DashboardForm = () => {
    ...
    const breadCrumb = [
        ...
        { name: "Driver's License Forms", href: "/dashboard/driver-license-forms", current: false },
        { name: "Learner's Permit", href: "/dashboard/learners-permit", current: true },
    ];
    ...
    return (
        <div className="w-full">
            <div className="w-full">
                ...
                {/* Form Title */}
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Learner's Permit Form</h1>
                ...
                <Card className="shadow-[0px_1px_3px_0px_#0051AF/10] border border-[#EAECF0] bg-white rounded-lg py-9 px-8">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="dateOfPurchase" className="font-medium">Date of Purchase of Vehicle</Label>
                                <div className="relative">
                                    <Input
                                        id="dateOfPurchase"
                                        type="date"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="vehicleModel1" className="font-medium">Model Number and Name of Vehicle</Label>
                                <Textarea
                                    id="vehicleModel1"
                                    placeholder="Type Something..."
                                    value={formData.vehicleModel1}
                                    onChange={(e) => handleInputChange('vehicleModel1', e.target.value)}
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="vehicleModel2" className="font-medium">Model Number and Name of Vehicle</Label>
                                <Textarea
                                    id="vehicleModel2"
                                    placeholder="Type Something..."
                                    value={formData.vehicleModel2}
                                    onChange={(e) => handleInputChange('vehicleModel2', e.target.value)}
                                    className="h-24 resize-none px-4 rounded-md border shadow-[0px_4px_4px_0px_#0000000D] backdrop-blur-[20px] bg-gradient-to-t from-[#E9E9E980]/50 to-[#FFFFFF0D]/5 text-sm placeholder:text-[#667085] py-1"
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="vehicleModel3" className="font-medium">Model Number and Name of Vehicle</Label>
                                <Textarea
                                    id="vehicleModel3"
                                    placeholder="Type Something..."
                                    value={formData.vehicleModel3}
                                    onChange={(e) => handleInputChange('vehicleModel3', e.target.value)}
                                    className="h-24 resize-none px-4 rounded-md border shadow-[0px_4px_4px_0px_#0000000D] backdrop-blur-[20px] bg-gradient-to-t from-[#E9E9E980]/50 to-[#FFFFFF0D]/5 text-sm placeholder:text-[#667085] py-1"
                                />
                            </div>
                        </div>
