...
const adminSidebarItems = [
  {
    ...
    treeData: [
      ...
      {
        id: '/dashboard/setup/matter-case-role',
        label: 'Matter Case Role',
        type: 'link',
        iconType: 'roles',
      },
      {
        id: '/dashboard/setup/matter-case-type',
        label: 'Matter Case Type',
        type: 'link',
        iconType: 'tree',
      },
      {
        id: '/dashboard/setup/matter-case-status',
        label: 'Matter Case Status',
        type: 'link',
        iconType: 'activity',
      },
      {
        id: '/dashboard/setup/matter-marketing-source',
        label: 'Matter Marketing Source',
        type: 'link',
        iconType: 'data',
      },
      {
        id: '/dashboard/setup/matter-ad-campaign',
        label: 'Matter Ad Campaign',
        type: 'link',
        iconType: 'data',
      },
      {
        id: '/dashboard/setup/matter-rating',
        label: 'Matter Rating',
        type: 'link',
        iconType: 'data',
      },
      {
        id: '/dashboard/setup/matter-call-outcome',
        label: 'Matter Call Outcome',
        type: 'link',
        iconType: 'communication',
      },
      {
        id: '/dashboard/setup/matter-office-location',
        label: 'Matter Office Location',
        type: 'link',
        iconType: 'contact',
      },
    ],
