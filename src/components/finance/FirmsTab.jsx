...
const FirmsTab = ({ slugId }) => {
  ...
  const canViewSubFirms = hasPermission('sub-firms.view');
  const canCreateSubFirm = hasPermission('sub-firms.create');
  ...
  return (
    <PermissionGuard
      permission="sub-firms.view"
      fallback={
        <div className="p-4">
          <div className="text-center py-8">
            <p className="text-red-600">
              You don't have permission to view sub-firms.
            </p>
          </div>
        </div>
      }
        ...
        <Stack spacing={3}>
          ...
          >
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              <PermissionGuard permission="sub-firms.create">
                <button
          ...
          >
            <PermissionGuard permission="sub-firms.show">
              <MenuItem
                onClick={() => {
                  if (selectedFirm) {
