...
const FirmDetail = ({ firmId }) => {
  ...
  const canShowSubFirm = hasPermission('sub-firms.show');
  const canUpdateSubFirm = hasPermission('sub-firms.update');
  const canDeleteSubFirm = hasPermission('sub-firms.delete');
  ...
  console.log(
    'Boolean permissions:',
    Object.entries(firm || {}).filter(
      ([key, value]) => typeof value === 'boolean' && key !== 'is_active'
    )
  );
        ...
        <div className="px-2">
          ...
          >
            <Typography variant="h6" color="error">
              You don't have permission to view firm details.
            </Typography>
          </Box>
        </div>
      }
        ...
        >
          ...
          >
            ...
            <Box sx={{ display: 'flex', gap: 1 }}>
              <PermissionGuard permission="sub-firms.update">
                <IconButton
                  onClick={handleEdit}
                  sx={{
                    color: '#7367F0',
              ...
              <PermissionGuard permission="sub-firms.delete">
                <IconButton
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Typography
                        variant="body1"
                        sx={{ fontWeight: 500, color: '#059669' }}
                      >
                  ...
                  <Typography variant="body2" color="text.secondary">
                    {
                      Object.entries(firm || {}).filter(
                        ([key, value]) =>
                          typeof value === 'boolean' && key !== 'is_active'
                      ).length
                    }{' '}
                    permissions
                  </Typography>
        ...
        >
          <Box sx={{ p: 3 }}>
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              Are you sure you want to delete "{firm?.name}"? This action cannot
              be undone.
            </Typography>
