...
const FeeSplitDetail = () => {
  ...
  const canViewFeeSplit = hasPermission('fee-splits.show');
  ...
  const deleteFeeSplitMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate(
        `/dashboard/inbox/finance?slugId=${slugId || ''}&tab=fee-splits`
      );
        ...
        <div className="px-2">
          ...
          >
            <Typography variant="h6" color="error">
              You don't have permission to view fee split details.
            </Typography>
          </Box>
        </div>
      }
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <Typography variant="body1" sx={{ fontWeight: 500 }}>
                          {feeSplit.created_at
                            ? new Date(feeSplit.created_at).toLocaleDateString()
                            : 'N/A'}
                        </Typography>
                      </div>
                    </div>
        ...
        >
          <div className="p-6">
            ...
            <Typography variant="body1" className="text-gray-600 mb-6">
              Are you sure you want to delete this fee split? This action cannot
              be undone.
            </Typography>
