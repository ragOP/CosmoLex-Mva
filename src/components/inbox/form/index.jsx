...
const Form = ({ matter, onSubmit, onCancel, mode = 'add', slug }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Form submitted:", { formData: getFormDataForSubmission(formData, mode), mode, slug });
    } catch (error) {
          ...
          {Object.keys(groupedFields).length > 0 ? (
            ...
            <Stack sx={{ textAlign: 'center', py: 4 }}>
              ...
              <Typography sx={{ color: 'text.disabled', fontSize: '0.875rem' }}>
                Contact your administrator to configure form fields for this case type.
              </Typography>
            </Stack>
          )}
        </Stack>
