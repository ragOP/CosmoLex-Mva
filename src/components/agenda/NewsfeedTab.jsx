...
const NewsfeedTab = () => {
    ...
    const newsfeed = Array.isArray(agendaResponse?.newsfeed) ? agendaResponse.newsfeed : [];

    const handleRefresh = () => {
        refetch();
    };

    const filteredNewsfeed = Array.isArray(newsfeed) ? newsfeed.filter(item =>
                        ...
                        <>
                            ...
                            {viewMode === 'grid' && (
                                <div className="w-full grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    {Array.isArray(filteredNewsfeed) && filteredNewsfeed.map((item, index) => (
                                        <div
                                            key={index}
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <Clock className="w-4 h-4 text-gray-400" />
                                                    <span className='text-sm text-gray'>Completed: {item.completed_on}</span>
                                                </div>
                                            </div>
